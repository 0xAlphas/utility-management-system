    ...
    <DashboardLayout allowedRoles={['ADMIN']}>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <button className="p-4 border-2 border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition text-left">
            ...
            <p className="text-sm text-gray-600">Staff administration</p>
          </button>
        </div>
      </div>
      ...
      <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
        <p className="text-sm text-blue-800">
          <strong>Admin Access:</strong> You have full system access including customer management,
          staff administration, billing, and all reports.
        </p>
      </div>
    </DashboardLayout>
  );
